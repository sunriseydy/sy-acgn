...
import dev.sunriseydy.acgn.anime.api.AnimeRssApi
...
class SyAcgnApi {
    ...
    val animeRss by buildApi(::AnimeRssApi)
...
internal fun HttpRequestBuilder.animeApiEndPoint(vararg paths: String) {
